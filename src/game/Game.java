...
//		session = new GameSession(4, 3, this);
	...
	public void endGame(){
		remove(session);
		/* 
		 * Tarkistetaan, mik‰ rata oli kyseess‰ ja ett‰ oliko auto Smart vai joku muu. Riippuen n‰ist‰ tekijˆist‰, kirjoitetaan sen mukaisiin tiedostoihin
		...
		/*
		 *  Riippuen ajetusta radasta ja siit‰, ajettiinko suoritus loppuun vai keskeytettiinkˆ se, metodi valitsee sen mukaisen menun numeron. 
